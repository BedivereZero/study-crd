...
import (
	...
	foov1alpha1 "github.com/BedivereZero/study-crd/pkg/client/clientset/versioned/typed/foo/v1alpha1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.fooV1alpha1, err = foov1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.fooV1alpha1 = foov1alpha1.NewForConfigOrDie(c)
